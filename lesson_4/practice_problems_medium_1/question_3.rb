...
# (calling the accessor with the instance.quantity = <new value> notation) rather than 
# by going through the update_quantity method. It means that the protections built into the update_quantity method 
